...
<title>Vente remportée par un autre utilisateur</title>
...
<h2 class="mt-5 mb-5">Jojo44 à remporté l'enchère</h2>	
	...
	<div class="container ">
		...
		<form method="post" action="">
					...
					<label for="nomArticle" class="label1 "><span class="label-monProfil"> Rocket stove pour riz et pâtes</span></label> <br>
					...
					<label for="meilleureOffre" class="label1 ">Meilleure offre : <span class="label-monProfil"> " "par " " </span></label> <br>
					<label for="miseAPrix" class="label1 ">Mise à prix : <span class="label-monProfil"></span></label> <br>
					
					<label for="retrait" class="label1 ">Fin de l'enchère : <span class="label-monProfil"></span></label><br>
					<label for="vendeur" class="label1 ">Retrait : <span class="label-monProfil"></span></label><br>
					...
					<div class="row">
							...
							<div class="container-btn-detailVente mt-2">
								<a href="${pageContext.request.contextPath}/ServletListeEncheres"><input type="button" name="retrait" class="btn-detailVente " value="Retrait à effectuer"></a>
								</div>
